...
* den Code als ZIP-Datei herunterladen: [rxjs-playground.zip](https://github.com/angular-schule/2023-12-angular-workshop-online/files/13536921/rxjs-playground.zip)<br>**oder**<br>
...
```bash
ng new book-rating --routing --standalone --style=scss --no-ssr
cd book-rating
ng serve
```
...
### &copy; https://angular.schule | Stand: 11.11.2023
